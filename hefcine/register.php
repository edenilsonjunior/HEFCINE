    ...
    <div id=telacentro>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div>
                ...
                <br>
                <span action="<?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>"
            ...
            <div>
                ...
                <span action="<?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>"
            ...
            <div>
                ...
                <span action="<?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>"
            ...
            <div>
                <button style="width: 148px;" type="submit" class="btn" value="Criar Conta" id="btanimation">Criar
                    Conta</button>
                <button style="width: 148px;" type="reset" class="btn" value="Apagar Dados" id="btanimation">Apagar
                    Dados</button>
            </div>
